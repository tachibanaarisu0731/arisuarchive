...
(lib.bg = function() {
	this.initialize(img._432_4_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1048,1200);


(lib.ch_base = function() {
	this.initialize(img._432_4_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1048,1200);


(lib.ch_face12 = function() {
	this.initialize(img._432_4_ch_face12);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face2 = function() {
	this.initialize(img._432_4_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face3 = function() {
	this.initialize(img._432_4_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face4 = function() {
	this.initialize(img._432_4_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face5 = function() {
	this.initialize(img._432_4_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face6 = function() {
	this.initialize(img._432_4_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face7 = function() {
	this.initialize(img._432_4_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face8 = function() {
	this.initialize(img._432_4_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ef_bleth = function() {
	this.initialize(img._432_4_ef_bleth);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,336,336);


(lib.finish = function() {
	this.initialize(img._432_4_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._432_4_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._432_4_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._432_4_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.トゥイーン2 = function(mode,startPosition,loop) {
	...
	// レイヤー_1
	this.instance = new lib.ef_bleth();
...
(lib.uru_gra = function(mode,startPosition,loop) {
	...
	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.8)").s().p("");
	this.shape.setTransform(0.0375,3.475);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.1,0.4,4.300000000000001,6.199999999999999);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,524,600), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,524,600);
...
(lib.ef_bleth_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(348.05,-16.05,0.3044,0.2909,-108.2477,0,0,0.4,0.3);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).wait(1).to({regX:0,regY:0,scaleX:0.305,scaleY:0.2915,rotation:-108.227,x:348.2615,y:-15.789,alpha:0.1239},0).wait(1).to({scaleX:0.3061,scaleY:0.2925,rotation:-108.1927,x:348.6949,y:-15.605,alpha:0.3292},0).wait(1).to({scaleX:0.3075,scaleY:0.2939,rotation:-108.1442,x:349.3085,y:-15.3444,alpha:0.6198},0).wait(1).to({regX:0.4,regY:0.5,scaleX:0.3095,scaleY:0.2957,rotation:-108.0806,x:350.15,y:-15.15,alpha:1},0).wait(1).to({regX:0,regY:0,scaleX:0.312,scaleY:0.2982,rotation:-108.0781,x:351.0175,y:-14.5851},0).wait(1).to({scaleX:0.3151,scaleY:0.3011,rotation:-108.075,x:352.1853,y:-14.0842},0).wait(1).to({scaleX:0.3187,scaleY:0.3045,rotation:-108.0714,x:353.5623,y:-13.4936},0).wait(1).to({scaleX:0.3229,scaleY:0.3085,rotation:-108.0672,x:355.1573,y:-12.8096},0).wait(1).to({scaleX:0.3276,scaleY:0.3131,rotation:-108.0625,x:356.9789,y:-12.0283},0).wait(1).to({regX:0.5,regY:0.7,scaleX:0.333,scaleY:0.3183,rotation:-108.0571,x:359.15,y:-11.3},0).wait(1).to({regX:0,regY:0,scaleX:0.3392,scaleY:0.3242,rotation:-108.0981,x:361.2442,y:-10.1048,alpha:0.785},0).wait(1).to({scaleX:0.3461,scaleY:0.3307,rotation:-108.1435,x:363.73,y:-9.0025,alpha:0.5469},0).wait(1).to({scaleX:0.3536,scaleY:0.3379,rotation:-108.1934,x:366.4613,y:-7.7913,alpha:0.2853},0).wait(1).to({regX:0.3,regY:0.6,scaleX:0.3618,scaleY:0.3457,rotation:-108.2478,x:369.6,y:-6.7,alpha:0},0).wait(1));

	// ef_bleth
	this.instance_1 = new lib.トゥイーン2("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(345.2,-9.3,0.3044,0.2909,-92.7874,0,0,0.5,0.6);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:0,regY:0,scaleX:0.305,scaleY:0.2915,rotation:-92.7667,x:345.2726,y:-8.9711,alpha:0.1239},0).wait(1).to({scaleX:0.3061,scaleY:0.2925,rotation:-92.7324,x:345.6413,y:-8.6746,alpha:0.3292},0).wait(1).to({scaleX:0.3075,scaleY:0.2939,rotation:-92.6838,x:346.1635,y:-8.2548,alpha:0.6198},0).wait(1).to({regX:0.3,regY:0.7,scaleX:0.3095,scaleY:0.2957,rotation:-92.6203,x:347,y:-7.85,alpha:1},0).wait(1).to({regX:0,regY:0,scaleX:0.312,scaleY:0.2981,rotation:-92.6178,x:347.6165,y:-7.0913},0).wait(1).to({scaleX:0.3151,scaleY:0.3011,rotation:-92.6147,x:348.602,y:-6.2962},0).wait(1).to({scaleX:0.3187,scaleY:0.3045,rotation:-92.6112,x:349.7641,y:-5.3587},0).wait(1).to({scaleX:0.3229,scaleY:0.3085,rotation:-92.607,x:351.1101,y:-4.2727},0).wait(1).to({scaleX:0.3276,scaleY:0.3131,rotation:-92.6023,x:352.6474,y:-3.0325},0).wait(1).to({regX:0.4,regY:0.7,scaleX:0.333,scaleY:0.3182,rotation:-92.5969,x:354.6,y:-1.75},0).wait(1).to({regX:0,regY:0,scaleX:0.3392,scaleY:0.3242,rotation:-92.638,x:356.3104,y:-0.0517,alpha:0.785},0).wait(1).to({scaleX:0.3461,scaleY:0.3307,rotation:-92.6834,x:358.4265,y:1.6633,alpha:0.5469},0).wait(1).to({scaleX:0.3536,scaleY:0.3379,rotation:-92.7333,x:360.7517,y:3.5476,alpha:0.2853},0).wait(1).to({regX:0.3,regY:0.8,scaleX:0.3618,scaleY:0.3457,rotation:-92.7878,x:363.55,y:5.45,alpha:0},0).to({_off:true},1).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(285.6,-82.5,158.09999999999997,151.9);
...
p.nominalBounds = new cjs.Rectangle(-2.2,0.3,4.5,6.5);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(7.975,0.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(-8.15,0.4);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(68.85,63.2,1.0632,0.5296,0,32.5646,37.1205,0.7,4.2);

	this.instance_2 = new lib.uru_set();
	this.instance_2.parent = this;
	this.instance_2.setTransform(52.8,80.05,1.0632,0.5296,0,32.5646,37.1205,0.7,4.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2},{t:this.instance_1}]},19).wait(1));
	...
	var maskedShapeInstanceList = [this.instance_3,this.instance_4,this.instance_5,this.instance_6,this.instance_7,this.instance_8,this.instance_9,this.instance_10];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).wait(11));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-73,259);
...
(lib.glitters = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(212.3,191.2,0.1412,0.1412);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(227.75,118.95,0.159,0.159,0,0,0,-1.3,2.9);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(216.25,252.15,0.1618,0.1618);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(222.55,221.1,0.1702,0.1702);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:74.5152,y:66.4398}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
...
p.nominalBounds = new cjs.Rectangle(-193,-137,524,600);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.f.name = "f";
	this.f.parent = this;
	this.f.setTransform(-73.75,-365.45);
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-146.75,-106.5);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-266.7,-502.5,576.9,634.2);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(1).call(this.frame_442).wait(22).call(this.frame_464).wait(1).call(this.frame_465).wait(16).call(this.frame_481).wait(1).call(this.frame_482).wait(16).call(this.frame_498).wait(1));

	// effect_look_to_right2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(62.05,-372.3,1.1645,1.1645,0,0,180);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:87.65,y:-381.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:99.3,y:-385.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:62.05,y:-372.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:87.65,y:-381.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:99.3,y:-385.6,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:62.05,y:-372.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:87.65,y:-381.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:99.3,y:-385.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:62.05,y:-372.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:87.65,y:-381.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:99.3,y:-385.6,alpha:0.2188},0).to({_off:true},1).wait(167));

	// effect_look_to_right
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(3.9,-279.55,1.4807,1.4807,0,0,180);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(3.95,-279.6,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(77.6,-367.85,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(93.6,-364.3,1.4181,1.4181,0,-35.8376,144.173,-30.2,20.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(70.5,-281.9,1.0026,1.0026,-6.2632,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(65.8,-364.8,1.053,1.053,29.448);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(69.55,-380.2,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(65.25,-362.7,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(63.85,-362.55,0.9876,0.9876,0,-14.9998,165.0002);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(70.3,-365.55,1.3878,1.3878,0,121.2396,-58.7604);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(43.85,-212.25,1,1,0,0,180);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(70.5,-321.7,0.4532,0.4532,0,0,180);
	this.instance_12._off = true;

	this.instance_13 = new lib.angry("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(77.05,-342.95,0.5276,0.5276);
	this.instance_13._off = true;

	this.instance_14 = new lib.mc_punpun();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-54,-392.1,1.1377,1.1377);

	this.instance_15 = new lib.concent_wrapper("synched",0,false);
	this.instance_15.parent = this;
	this.instance_15.setTransform(3.7,-280.15,1,1,0,0,0,-0.5,-0.1);

	this.instance_16 = new lib.ef_bleth_1("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(-265.35,-199.75);
	this.instance_16.alpha = 0.5898;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_2}]},10).to({state:[]},10).to({state:[{t:this.instance_3}]},76).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},7).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},16).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},24).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},11).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},2).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},6).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},5).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},2).to({state:[]},12).to({state:[{t:this.instance_15}]},17).to({state:[{t:this.instance_16}]},9).to({state:[{t:this.instance_16}]},23).to({state:[{t:this.instance_16}]},17).wait(17));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-367.9},0).wait(3).to({regX:-28.8,x:77.2,y:-367.75,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:77.6,y:-367.9,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.1857,scaleY:1.1857,rotation:169.9438,y:-367.85,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-367.9},0).wait(3).to({regX:-28.8,x:77.2,y:-367.75,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:77.6,y:-367.9,alpha:0},0).to({_off:true},1).wait(340));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({regX:-30.3,regY:20.4,skewX:-35.827,skewY:144.1725,x:93.65,y:-364.45},0).wait(1).to({regX:-31.4,regY:22.1,x:96.3,y:-363.4,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.4,x:93.65,y:-364.45,alpha:0,startPosition:19},0).to({_off:true},1).wait(319));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:73.45,y:-377.75,alpha:0.5556},0).wait(1).to({x:78.25,y:-385.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:80.2,y:-388.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:79.55,y:-387.65},0).wait(1).to({x:78.5,y:-385.8},0).wait(1).to({x:76.75,y:-382.7},0).wait(1).to({regX:0,regY:0,x:74.6,y:-378.5},0).to({x:75.35,y:-379.85},2).wait(8).to({regX:-0.2,regY:0.2,x:74.7,y:-379.15,alpha:0.9298},0).wait(1).to({x:73.6,y:-377.2,alpha:0.692},0).wait(1).to({x:72,y:-374.35,alpha:0.339},0).wait(1).to({x:70.8,y:-372.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-371.7,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:65.8,y:-364.8},0).wait(1).to({regX:-0.2,regY:0.2,x:73.45,y:-377.75,alpha:0.5556},0).wait(1).to({x:78.25,y:-385.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:80.2,y:-388.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:79.55,y:-387.65},0).wait(1).to({x:78.5,y:-385.8},0).wait(1).to({x:76.75,y:-382.7},0).wait(1).to({regX:0,regY:0,x:74.6,y:-378.5},0).to({x:75.35,y:-379.85},2).wait(3).to({regX:-0.2,regY:0.2,x:74.7,y:-379.15,alpha:0.9298},0).wait(1).to({x:73.6,y:-377.2,alpha:0.692},0).wait(1).to({x:72,y:-374.35,alpha:0.339},0).wait(1).to({x:70.8,y:-372.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-371.7,alpha:0},0).to({_off:true},1).wait(252));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:66.25,y:-359},0).wait(1).to({y:-355.15},0).wait(1).to({y:-351.9},0).wait(1).to({y:-349.25},0).wait(1).to({y:-347.15},0).wait(1).to({y:-345.65},0).wait(1).to({y:-344.75},0).wait(1).to({regX:-0.5,regY:0.2,x:65.25,y:-343.7},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:66.25,y:-344.5,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:65.25,y:-343.7,alpha:0},0).to({_off:true},1).wait(210));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:95.275,y:-357.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:105.75,y:-356.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:63.85,y:-362.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:95.275,y:-362.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:105.75,y:-362.25,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:63.85,y:-362.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:95.275,y:-357.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:105.75,y:-356.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:63.85,y:-362.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:95.275,y:-362.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:105.75,y:-362.25,alpha:0.2188},0).to({_off:true},1).wait(167));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:44.85,y:-211.25,alpha:1},0).wait(1).to({regX:0.9,x:44.95,y:-210.3,alpha:0.8965},0).wait(1).to({x:46.3,y:-209.1,alpha:0.7636},0).wait(1).to({x:47.9,y:-207.65,alpha:0.6048},0).wait(1).to({x:49.7,y:-206.05,alpha:0.4229},0).wait(1).to({x:51.7,y:-204.2,alpha:0.2205},0).wait(1).to({regX:0,x:54.85,y:-202.25,alpha:0},0).to({_off:true},1).wait(140));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:72.25,y:-335.85},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:75.5,y:-341.7},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:72.95,y:-339.55},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:72.4,y:-336.3},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:73.5,y:-331.7},0).to({scaleX:1,scaleY:1,x:74.5,y:-335.7},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:71.9,y:-334.7,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:73.5,y:-335.45,alpha:0.1016},0).to({_off:true},1).wait(116));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-4.8,regY:-202.5,x:-4.8,y:-210.9},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-211.7},0).wait(1).to({y:-208.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-208},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-208.25},0).wait(1).to({y:-201.3},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-199.25},0).wait(1).to({y:-201.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-207.45},0).wait(1).to({y:-201.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-207.45},0).wait(1).to({y:-201.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-201.6},0).wait(1).to({y:-202.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-211.5},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-215.45},0).wait(1).to({y:-211.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-200.5},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-202.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-211.5},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-215.45},0).wait(1).to({y:-211.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-200.5},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-202.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-4.8,regY:-202.5,x:-4.8,y:-201.9},0).wait(1).to({y:-199.5},0).wait(1).to({y:-197.15},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-197.15},0).wait(1).to({y:-199.5},0).wait(1).to({y:-201.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-4.8,regY:-202.5,x:-4.8,y:-202.35},0).wait(1).to({y:-201.8},0).wait(1).to({y:-200.7},0).wait(1).to({y:-199.35},0).wait(1).to({y:-198.25},0).wait(1).to({y:-197.7},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-197.7},0).wait(1).to({y:-198.25},0).wait(1).to({y:-199.35},0).wait(1).to({y:-200.7},0).wait(1).to({y:-201.8},0).wait(1).to({y:-202.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-197.75},0).wait(1).to({y:-201.3},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-200.3},0).wait(1).to({y:-202.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-4.8,regY:-202.5,scaleX:0.9999,scaleY:0.9999,rotation:0.0163,x:-4.75,y:-202.5},0).wait(1).to({scaleX:0.9996,scaleY:0.9996,rotation:0.0728,x:-4.4,y:-202.4},0).wait(1).to({scaleX:0.9991,scaleY:0.9991,rotation:0.1835,x:-3.75,y:-202.3},0).wait(1).to({scaleX:0.9982,scaleY:0.9982,rotation:0.3589,x:-2.8,y:-202.15},0).wait(1).to({scaleX:0.9971,scaleY:0.9971,rotation:0.5792,x:-1.5,y:-201.9},0).wait(1).to({scaleX:0.996,scaleY:0.996,rotation:0.7789,x:-0.35,y:-201.65},0).wait(1).to({scaleX:0.9954,scaleY:0.9954,rotation:0.9121,x:0.4,y:-201.55},0).wait(1).to({scaleX:0.995,scaleY:0.995,rotation:0.9805,x:0.8,y:-201.4},0).wait(1).to({regX:0.3,regY:0.1,scaleX:0.9949,scaleY:0.9949,rotation:1,x:2.2,y:0.1},0).wait(1).to({regX:-4.8,regY:-202.5,scaleX:0.995,scaleY:0.995,rotation:0.987,x:0.5,y:-201.55},0).wait(1).to({scaleX:0.9952,scaleY:0.9952,rotation:0.9424,x:0.25,y:-201.6},0).wait(1).to({scaleX:0.9956,scaleY:0.9956,rotation:0.8563,x:-0.25,y:-201.65},0).wait(1).to({scaleX:0.9964,scaleY:0.9964,rotation:0.7189,x:-1,y:-201.8},0).wait(1).to({scaleX:0.9973,scaleY:0.9973,rotation:0.5331,x:-2.05,y:-202.05},0).wait(1).to({scaleX:0.9983,scaleY:0.9983,rotation:0.3347,x:-3.2,y:-202.25},0).wait(1).to({scaleX:0.9991,scaleY:0.9991,rotation:0.1737,x:-4.15,y:-202.4},0).wait(1).to({scaleX:0.9996,scaleY:0.9996,rotation:0.0696,x:-4.65,y:-202.55},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.0157,x:-5,y:-202.6},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:0,x:0,y:0},0).wait(2).to({regX:-4.8,regY:-202.5,scaleX:0.9999,scaleY:0.9999,rotation:0.0163,x:-4.75,y:-202.5},0).wait(1).to({scaleX:0.9996,scaleY:0.9996,rotation:0.0728,x:-4.4,y:-202.4},0).wait(1).to({scaleX:0.9991,scaleY:0.9991,rotation:0.1835,x:-3.75,y:-202.3},0).wait(1).to({scaleX:0.9982,scaleY:0.9982,rotation:0.3589,x:-2.8,y:-202.15},0).wait(1).to({scaleX:0.9971,scaleY:0.9971,rotation:0.5792,x:-1.5,y:-201.9},0).wait(1).to({scaleX:0.996,scaleY:0.996,rotation:0.7789,x:-0.35,y:-201.65},0).wait(1).to({scaleX:0.9954,scaleY:0.9954,rotation:0.9121,x:0.4,y:-201.55},0).wait(1).to({scaleX:0.995,scaleY:0.995,rotation:0.9805,x:0.8,y:-201.4},0).wait(1).to({regX:0.3,regY:0.1,scaleX:0.9949,scaleY:0.9949,rotation:1,x:2.2,y:0.1},0).wait(1).to({regX:-4.8,regY:-202.5,scaleX:0.995,scaleY:0.995,rotation:0.987,x:0.5,y:-201.55},0).wait(1).to({scaleX:0.9952,scaleY:0.9952,rotation:0.9424,x:0.25,y:-201.6},0).wait(1).to({scaleX:0.9956,scaleY:0.9956,rotation:0.8563,x:-0.25,y:-201.65},0).wait(1).to({scaleX:0.9964,scaleY:0.9964,rotation:0.7189,x:-1,y:-201.8},0).wait(1).to({scaleX:0.9973,scaleY:0.9973,rotation:0.5331,x:-2.05,y:-202.05},0).wait(1).to({scaleX:0.9983,scaleY:0.9983,rotation:0.3347,x:-3.2,y:-202.25},0).wait(1).to({scaleX:0.9991,scaleY:0.9991,rotation:0.1737,x:-4.15,y:-202.4},0).wait(1).to({scaleX:0.9996,scaleY:0.9996,rotation:0.0696,x:-4.65,y:-202.55},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.0157,x:-5,y:-202.6},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:0,x:0,y:0},0).wait(16).to({regX:-4.8,regY:-202.5,x:-4.8,y:-208.05},0).wait(1).to({y:-209.95},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-209.85},0).wait(1).to({y:-207.75},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-4.8,regY:-202.5,x:-4.8,y:-210.9},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-211.7},0).wait(1).to({y:-208.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:-4.8,regY:-202.5,rotation:-0.0253,x:-4.9,y:-202.4},0).wait(1).to({rotation:-0.1129,x:-5.1,y:-201.85},0).wait(1).to({rotation:-0.2845,x:-5.45,y:-200.85},0).wait(1).to({rotation:-0.5565,x:-6.05,y:-199.25},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-6.8,y:-197.15},0).wait(1).to({rotation:-1.2075,x:-7.5,y:-195.35},0).wait(1).to({rotation:-1.4141,x:-8,y:-194.1},0).wait(1).to({rotation:-1.5201,x:-8.2,y:-193.45},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:-4.8,regY:-202.5,rotation:-1.5305,x:-8.25,y:-193.4},0).wait(1).to({rotation:-1.4624,x:-8.1,y:-193.85},0).wait(1).to({rotation:-1.3309,x:-7.8,y:-194.6},0).wait(1).to({rotation:-1.121,x:-7.35,y:-195.9},0).wait(1).to({rotation:-0.8372,x:-6.7,y:-197.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-6.05,y:-199.45},0).wait(1).to({rotation:-0.2881,x:-5.5,y:-200.95},0).wait(1).to({rotation:-0.1291,x:-5.15,y:-201.9},0).wait(1).to({rotation:-0.0467,x:-4.95,y:-202.4},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-4.8,regY:-202.5,rotation:0.1421,x:-4.15,y:-202.05},0).wait(1).to({rotation:0.6998,x:-1.45,y:-200.2},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:1.65,y:-198.15},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:-4.8,regY:-202.5,rotation:1.4399,x:2.15,y:-197.75},0).wait(1).to({rotation:1.2196,x:1.05,y:-198.55},0).wait(1).to({rotation:0.7884,x:-1,y:-199.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:-3.35,y:-201.5},0).wait(1).to({rotation:0.0482,x:-4.65,y:-202.35},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-4.8,regY:-202.5,rotation:0.0865,x:-4.4,y:-202.25},0).wait(1).to({rotation:0.4213,x:-2.75,y:-201.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:0,y:-199.25},0).wait(1).to({rotation:1.3945,x:2,y:-197.85},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:-4.8,regY:-202.5,rotation:1.4399,x:2.15,y:-197.75},0).wait(1).to({rotation:1.2196,x:1.05,y:-198.55},0).wait(1).to({rotation:0.7884,x:-1,y:-199.9},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:-3.35,y:-201.5},0).wait(1).to({rotation:0.0482,x:-4.65,y:-202.35},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-210.9},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-211.7},0).wait(1).to({y:-208.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-4.8,regY:-202.5,x:-7.55,y:-194.75},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-4.8,regY:-202.5,x:-4.8,y:-190.25},0).wait(1).to({y:-193.2},0).wait(1).to({y:-198.15},0).wait(1).to({y:-201.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-201.5},0).wait(1).to({y:-195.55},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-4.8,regY:-202.5,x:-4.8,y:-194.7},0).wait(1).to({y:-199},0).wait(1).to({y:-203.3},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-203},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-4.8,regY:-202.5,x:-4.8,y:-209.2},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-209.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-210.9},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-211.7},0).wait(1).to({y:-208.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-4.8,regY:-202.5,x:-7.55,y:-194.75},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-4.8,regY:-202.5,x:-4.8,y:-191.75},0).wait(1).to({y:-199.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-203.5},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-202.65},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-202},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-4.8,regY:-202.5,x:-4.8,y:-201.9},0).wait(1).to({y:-199.5},0).wait(1).to({y:-197.15},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-197.1},0).wait(1).to({y:-197.4},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-4.8,regY:-202.5,x:-4.8,y:-197.9},0).wait(1).to({y:-199.4},0).wait(1).to({y:-201.65},0).wait(1).to({y:-203.1},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-202.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-210.1},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-211.7},0).wait(1).to({y:-208.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-4.8,regY:-202.5,x:-4.8,y:-210},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:-4.8,regY:-202.5,x:-4.8,y:-210.5},0).wait(1).to({y:-204.5},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:-4.8,regY:-202.5,x:-4.8,y:-197.85},0).wait(1).to({y:-199.05},0).wait(1).to({y:-201},0).wait(1).to({y:-202.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-207.45},0).wait(1).to({y:-201.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-207.45},0).wait(1).to({y:-201.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-201.6},0).wait(1).to({y:-202.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-4.8,regY:-202.5,x:-1.8,y:-199.1},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-4.8,regY:-202.5,x:-5.65,y:-193.05},0).wait(1).to({x:-5,y:-192.65},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-4.8,regY:-202.5,x:-4.8,y:-193.2},0).wait(1).to({y:-195.65},0).wait(1).to({y:-199.35},0).wait(1).to({y:-201.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:-4.8,regY:-202.5,scaleX:0.9999,scaleY:0.9999,rotation:0.0163,x:-4.75,y:-202.5},0).wait(1).to({scaleX:0.9996,scaleY:0.9996,rotation:0.0728,x:-4.4,y:-202.4},0).wait(1).to({scaleX:0.9991,scaleY:0.9991,rotation:0.1835,x:-3.75,y:-202.3},0).wait(1).to({scaleX:0.9982,scaleY:0.9982,rotation:0.3589,x:-2.8,y:-202.15},0).wait(1).to({scaleX:0.9971,scaleY:0.9971,rotation:0.5792,x:-1.5,y:-201.9},0).wait(1).to({scaleX:0.996,scaleY:0.996,rotation:0.7789,x:-0.35,y:-201.65},0).wait(1).to({scaleX:0.9954,scaleY:0.9954,rotation:0.9121,x:0.4,y:-201.55},0).wait(1).to({scaleX:0.995,scaleY:0.995,rotation:0.9805,x:0.8,y:-201.4},0).wait(1).to({regX:0.3,regY:0.1,scaleX:0.9949,scaleY:0.9949,rotation:1,x:2.2,y:0.1},0).wait(1).to({regX:-4.8,regY:-202.5,scaleX:0.995,scaleY:0.995,rotation:0.9867,x:0.5,y:-201.55},0).wait(1).to({scaleX:0.9952,scaleY:0.9952,rotation:0.9411,x:0.25,y:-201.6},0).wait(1).to({scaleX:0.9956,scaleY:0.9956,rotation:0.853,x:-0.25,y:-201.65},0).wait(1).to({scaleX:0.9964,scaleY:0.9964,rotation:0.7125,x:-1.05,y:-201.8},0).wait(1).to({scaleX:0.9973,scaleY:0.9973,rotation:0.5225,x:-2.1,y:-202.05},0).wait(1).to({scaleX:0.9983,scaleY:0.9983,rotation:0.3195,x:-3.3,y:-202.25},0).wait(1).to({scaleX:0.9991,scaleY:0.9991,rotation:0.1549,x:-4.2,y:-202.4},0).wait(1).to({scaleX:0.9996,scaleY:0.9996,rotation:0.0485,x:-4.75,y:-202.5},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.0067,x:-5.05,y:-202.6},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:-0.0227,x:0,y:0},0).wait(4).to({rotation:0,y:2},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-208},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-208.25},0).wait(1).to({y:-201.3},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-4.8,regY:-202.5,x:-4.8,y:-199.25},0).wait(1).to({y:-201.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(26));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-402.1,-680.4,813.5,812.9);
...
// stage content:
(lib._432_4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:190,scene2:191,end2:311,scene3:312,end3:448,scene4:449,end4:591,scene5:592,end5:721,scene6:722,end6:855,scene7:856,end7:1020});
	...
	this.frame_69 = function() {
		...
		exportRoot._g.m2 = "に……っ｡";
		exportRoot._u.setText();
		this.ch1.gotoAndPlay("jump_bleth");
	...
	this.frame_592 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "かったでしょう?";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 6);
		this.ch1.gotoAndPlay("ef_bleth");
	}
	this.frame_642 = function() {
		exportRoot._g.m2 = "かったでしょう? 今年も､";
		exportRoot._u.setText();
		this.ch1.gotoAndPlay("nod");
		exportRoot._u.setFace("ch1", 7);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(19).call(this.frame_34).wait(11).call(this.frame_45).wait(6).call(this.frame_51).wait(18).call(this.frame_69).wait(33).call(this.frame_102).wait(11).call(this.frame_113).wait(7).call(this.frame_120).wait(19).call(this.frame_139).wait(20).call(this.frame_159).wait(31).call(this.frame_190).wait(1).call(this.frame_191).wait(29).call(this.frame_220).wait(29).call(this.frame_249).wait(26).call(this.frame_275).wait(22).call(this.frame_297).wait(14).call(this.frame_311).wait(1).call(this.frame_312).wait(12).call(this.frame_324).wait(35).call(this.frame_359).wait(18).call(this.frame_377).wait(26).call(this.frame_403).wait(28).call(this.frame_431).wait(8).call(this.frame_439).wait(9).call(this.frame_448).wait(1).call(this.frame_449).wait(35).call(this.frame_484).wait(11).call(this.frame_495).wait(30).call(this.frame_525).wait(35).call(this.frame_560).wait(12).call(this.frame_572).wait(19).call(this.frame_591).wait(1).call(this.frame_592).wait(50).call(this.frame_642).wait(13).call(this.frame_655).wait(26).call(this.frame_681).wait(28).call(this.frame_709).wait(12).call(this.frame_721).wait(1).call(this.frame_722).wait(11).call(this.frame_733).wait(21).call(this.frame_754).wait(30).call(this.frame_784).wait(29).call(this.frame_813).wait(14).call(this.frame_827).wait(12).call(this.frame_839).wait(16).call(this.frame_855).wait(1).call(this.frame_856).wait(16).call(this.frame_872).wait(23).call(this.frame_895).wait(46).call(this.frame_941).wait(18).call(this.frame_959).wait(48).call(this.frame_1007).wait(13).call(this.frame_1020).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1020).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1025));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1006));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1010));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},15).wait(1010));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(901).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(941).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},941).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(941).to({_off:false},0).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(941).to({_off:false},0).wait(1).to({alpha:0.9461},0).wait(1).to({alpha:0.9361},0).wait(1).to({alpha:0.9184},0).wait(1).to({alpha:0.8922},0).wait(1).to({alpha:0.8564},0).wait(1).to({alpha:0.8097},0).wait(1).to({alpha:0.751},0).wait(1).to({alpha:0.6794},0).wait(1).to({alpha:0.5947},0).wait(1).to({alpha:0.498},0).wait(1).to({alpha:0.3933},0).wait(1).to({alpha:0.2876},0).wait(1).to({alpha:0.1906},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0545},0).wait(1).to({alpha:0.022},0).wait(1).to({alpha:0.0117},0).to({_off:true},1).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(941).to({_off:false},0).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(929).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(837).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13},{t:this.instance_12}]}).to({state:[]},15).wait(1010));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(15).to({_off:false},0).wait(1010));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({scaleX:0.74,scaleY:0.74,x:116.4,y:260.85},0).to({y:347.65},40,cjs.Ease.quadInOut).wait(137).to({regX:5.5,regY:-274.9,scaleX:0.7397,scaleY:0.7397,x:120.45,y:144.15},0).wait(1).to({scaleX:0.7387,scaleY:0.7387,y:144.1},0).wait(1).to({scaleX:0.737,scaleY:0.737,y:143.85},0).wait(1).to({scaleX:0.7345,scaleY:0.7345,y:143.6},0).wait(1).to({scaleX:0.7312,scaleY:0.7312,x:120.4,y:143.25},0).wait(1).to({scaleX:0.727,scaleY:0.727,y:142.75},0).wait(1).to({scaleX:0.7219,scaleY:0.7219,y:142.2},0).wait(1).to({scaleX:0.7157,scaleY:0.7157,y:141.5},0).wait(1).to({scaleX:0.7086,scaleY:0.7086,x:120.35,y:140.7},0).wait(1).to({scaleX:0.7004,scaleY:0.7004,y:139.8},0).wait(1).to({scaleX:0.6913,scaleY:0.6913,x:120.3,y:138.8},0).wait(1).to({scaleX:0.6814,scaleY:0.6814,y:137.75},0).wait(1).to({scaleX:0.6708,scaleY:0.6708,x:120.25,y:136.55},0).wait(1).to({scaleX:0.6598,scaleY:0.6598,y:135.3},0).wait(1).to({scaleX:0.6487,scaleY:0.6487,x:120.2,y:134.1},0).wait(1).to({scaleX:0.6376,scaleY:0.6376,x:120.15,y:132.85},0).wait(1).to({scaleX:0.627,scaleY:0.627,y:131.7},0).wait(1).to({scaleX:0.617,scaleY:0.617,x:120.1,y:130.6},0).wait(1).to({scaleX:0.6078,scaleY:0.6078,y:129.5},0).wait(1).to({scaleX:0.5995,scaleY:0.5995,x:120.05,y:128.6},0).wait(1).to({scaleX:0.5921,scaleY:0.5921,y:127.8},0).wait(1).to({scaleX:0.5856,scaleY:0.5856,x:120,y:127.1},0).wait(1).to({scaleX:0.5801,scaleY:0.5801,x:120.05,y:126.45},0).wait(1).to({scaleX:0.5755,scaleY:0.5755,x:120,y:126},0).wait(1).to({scaleX:0.5718,scaleY:0.5718,y:125.55},0).wait(1).to({scaleX:0.5689,scaleY:0.5689,y:125.2},0).wait(1).to({scaleX:0.5666,scaleY:0.5666,x:119.95,y:125},0).wait(1).to({scaleX:0.5651,scaleY:0.5651,y:124.8},0).wait(1).to({scaleX:0.5643,scaleY:0.5643,y:124.75},0).wait(1).to({regX:0,regY:0,scaleX:0.564,scaleY:0.564,x:116.9,y:279.75},0).wait(228).to({scaleX:0.6997,scaleY:0.6997,x:100.55,y:327.15},34,cjs.Ease.quadInOut).wait(109).to({x:118.95},30,cjs.Ease.quadInOut).wait(100).to({scaleX:0.7738,scaleY:0.7738,x:119.05,y:347.95},32,cjs.Ease.quadInOut).wait(102).to({scaleX:0.564,scaleY:0.564,x:116.9,y:279.75},0).to({_off:true},85).wait(84));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-1.95,-44.1,0.8556,0.8556);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({scaleX:0.74,scaleY:0.74,x:-81,y:-111},0).to({y:-24.2},40,cjs.Ease.quadInOut).wait(137).to({regX:262,regY:300,scaleX:0.7397,scaleY:0.7397,x:112.9,y:197.75},0).wait(1).to({scaleX:0.7387,scaleY:0.7387,y:197.6},0).wait(1).to({scaleX:0.737,scaleY:0.737,x:112.95,y:197.25},0).wait(1).to({scaleX:0.7345,scaleY:0.7345,y:196.8},0).wait(1).to({scaleX:0.7312,scaleY:0.7312,y:196.2},0).wait(1).to({scaleX:0.727,scaleY:0.727,x:113,y:195.45},0).wait(1).to({scaleX:0.7219,scaleY:0.7219,y:194.5},0).wait(1).to({scaleX:0.7157,scaleY:0.7157,x:113.05,y:193.35},0).wait(1).to({scaleX:0.7086,scaleY:0.7086,x:113.15,y:192.05},0).wait(1).to({scaleX:0.7004,scaleY:0.7004,x:113.2,y:190.55},0).wait(1).to({scaleX:0.6913,scaleY:0.6913,x:113.3,y:188.9},0).wait(1).to({scaleX:0.6814,scaleY:0.6814,x:113.35,y:187.05},0).wait(1).to({scaleX:0.6708,scaleY:0.6708,x:113.4,y:185.15},0).wait(1).to({scaleX:0.6598,scaleY:0.6598,x:113.5,y:183.15},0).wait(1).to({scaleX:0.6487,scaleY:0.6487,x:113.6,y:181.1},0).wait(1).to({scaleX:0.6376,scaleY:0.6376,x:113.65,y:179.05},0).wait(1).to({scaleX:0.627,scaleY:0.627,x:113.8,y:177.1},0).wait(1).to({scaleX:0.617,scaleY:0.617,x:113.85,y:175.3},0).wait(1).to({scaleX:0.6078,scaleY:0.6078,x:113.9,y:173.6},0).wait(1).to({scaleX:0.5995,scaleY:0.5995,x:113.95,y:172.1},0).wait(1).to({scaleX:0.5921,scaleY:0.5921,x:114,y:170.7},0).wait(1).to({scaleX:0.5856,scaleY:0.5856,x:114.1,y:169.55},0).wait(1).to({scaleX:0.5801,scaleY:0.5801,y:168.55},0).wait(1).to({scaleX:0.5755,scaleY:0.5755,x:114.15,y:167.65},0).wait(1).to({scaleX:0.5718,scaleY:0.5718,y:167},0).wait(1).to({scaleX:0.5689,scaleY:0.5689,x:114.2,y:166.45},0).wait(1).to({scaleX:0.5666,scaleY:0.5666,y:166.05},0).wait(1).to({scaleX:0.5651,scaleY:0.5651,y:165.8},0).wait(1).to({scaleX:0.5643,scaleY:0.5643,x:114.25,y:165.65},0).wait(1).to({regX:-0.1,regY:-0.1,scaleX:0.564,scaleY:0.564,x:-33.55,y:-3.65},0).wait(228).to({scaleX:0.6997,scaleY:0.6997,x:-86.05,y:-24.4},34,cjs.Ease.quadInOut).wait(109).to({x:-67.65},30,cjs.Ease.quadInOut).wait(100).to({regY:-0.2,scaleX:0.7738,scaleY:0.7738,x:-87.35,y:-40.9},32,cjs.Ease.quadInOut).wait(102).to({regY:-0.1,scaleX:0.564,scaleY:0.564,x:-33.55,y:-3.65},0).to({_off:true},85).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},929).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).wait(929).to({_off:true},12).wait(79).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,902,1340);
// library properties:
lib.properties = {
	id: '_432_4',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1608867599275", id:"_432_4_bg"},
		{src:"images/ch_base.png?1608867599275", id:"_432_4_ch_base"},
		{src:"images/ch_face12.png?1608867599275", id:"_432_4_ch_face12"},
		{src:"images/ch_face2.png?1608867599275", id:"_432_4_ch_face2"},
		{src:"images/ch_face3.png?1608867599275", id:"_432_4_ch_face3"},
		{src:"images/ch_face4.png?1608867599275", id:"_432_4_ch_face4"},
		{src:"images/ch_face5.png?1608867599275", id:"_432_4_ch_face5"},
		{src:"images/ch_face6.png?1608867599275", id:"_432_4_ch_face6"},
		{src:"images/ch_face7.png?1608867599275", id:"_432_4_ch_face7"},
		{src:"images/ch_face8.png?1608867599275", id:"_432_4_ch_face8"},
		{src:"images/ef_bleth.png?1608867599275", id:"_432_4_ef_bleth"},
		{src:"images/finish.jpg?1608867599275", id:"_432_4_finish"},
		{src:"images/finish_blur.jpg?1608867599275", id:"_432_4_finish_blur"},
		{src:"images/tie_fp.png?1608867599275", id:"_432_4_tie_fp"},
		{src:"images/tie_sp.png?1608867599275", id:"_432_4_tie_sp"}
	],
	preloads: []
};
